...
function BufferPack() {
  ...
  m.calcLength = function (format, values) {
    ...
    // stringToBytes: takes a string returns an array of char values.
    // Because the WebSocket server sends data in string form and 
    // jspack expects arrays of byte values, this translates strings
    // from the network into a form suitable for processing by jspack
